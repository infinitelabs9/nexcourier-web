(function exposeNexCourierPremiumDemo(global) {
  ...
  const premiumData = {
    ...
    expenses: [
      expense("EXP-DEMO-001", "02 Sep 2026", "Operativo", "Aeropuerto / handling", "Aeropuerto", "Proveedor Handling Demo", "₲ 18.400.000", "Supervisor Courier Demo", "Pendiente", { shipmentId: "NXS-MIA-ASU-260918-A" }),
      ...
      expense("EXP-DEMO-008", "13 Sep 2026", "Administrativo", "Software", "Administración", "Software Demo", "USD 780", "Administración Demo", "Aprobado demo"),
