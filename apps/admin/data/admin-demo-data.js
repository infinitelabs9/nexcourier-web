(function exposeNexCourierAdminDemo(global) {
  ...
  const adminData = {
    ...
    metrics: [
      { label: "Recibidos hoy", value: 82, page: "reception", tone: "neutral", note: "↑ +12 desde las 08:00", trend: "positive" },
      { label: "Sin identificar", value: 4, page: "unidentified", tone: "critical", note: "↓ 1 caso vs. ayer", trend: "positive" },
      { label: "Documentos pendientes", value: 7, page: "documents", tone: "warning", note: "↑ 2 desde ayer", trend: "negative" },
      { label: "Por despachar", value: 63, page: "shipments", tone: "info", note: "↑ 8.2% vs. ayer", trend: "positive" },
      { label: "Llegadas Paraguay", value: 104, page: "arrivals", tone: "neutral", note: "2 recepciones activas", trend: "neutral" },
      { label: "Listos para retirar", value: 47, page: "deliveries", tone: "success", note: "↑ 6 desde las 08:00", trend: "positive" },
      { label: "Delivery pendiente", value: 12, page: "deliveries", tone: "warning", note: "↓ 3 casos vs. ayer", trend: "positive" },
    ],
    priorities: [
